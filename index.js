        ...
        return (
            <div id="quote-box" className="container pt-5">
                <div className="jumbotron">
                    ...
                    <button id="new-quote" className="btn btn-light " onClick={this.handleChange}>New quote</button>
                    <a href="twitter.com/intent/tweet"id="tweet-quote" className="btn btn-light"><button></button> </a>
                </div>
            </div>
        )
    }
